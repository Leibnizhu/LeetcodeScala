...
object TrappingRain {
   ...
   */
    def trap(height: Array[Int]): Int = {
      ...
      val leftWater = ((0 until peakIndex).foldLeft((0,0)) {(cur, i) => if(height(i) > cur._1) (height(i), cur._2) else (cur._1, cur._2 + cur._1-height(i))})._2 //左边接到的雨水
      (height.length - 1 until peakIndex by -1).foldLeft((0, leftWater)) {(cur, i) => if(height(i) > cur._1) (height(i), cur._2) else (cur._1, cur._2 + cur._1 - height(i))} _2
    }
}